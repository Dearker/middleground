...
5、sonarQube
    ...
    docker run -d -p 9000:9000 -m 2048M --cpus=0.2 -e "SONARQUBE_JDBC_URL=jdbc:postgresql://114.67.102.137:5432/sonarDB" -e "SONARQUBE_JDBC_USERNAME=sonarUser" -e "SONARQUBE_JDBC_PASSWORD=123456" --name sonarqube sonarqube:lts
